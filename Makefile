...
PROGRAM_SRCS = $(wildcard $(SRC_DIR)/*.c) $(wildcard $(SRC_DIR)/*.h) $(wildcard $(SRC_DIR)/*.S) $(wildcard $(SRC_DIR)/sensors/*.c) $(wildcard $(SRC_DIR)/sensors/*.h) $(wildcard $(SRC_DIR)/utils/*.c) $(wildcard $(SRC_DIR)/led/*.c)
